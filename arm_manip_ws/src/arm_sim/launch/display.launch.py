...
def generate_launch_description():
    arm_description_dir = get_package_share_directory("arm_sim")
    
    # Change 1: Update default file extension from .xacro to .urdf
    model_arg = DeclareLaunchArgument(
        name="model", 
        default_value=os.path.join(arm_description_dir, "urdf", "arm_sim.urdf"),  # Changed from .urdf.xacro to .urdf
    ...
    def get_urdf_content():
        urdf_file_path = os.path.join(arm_description_dir, "urdf", "arm_sim.urdf")
